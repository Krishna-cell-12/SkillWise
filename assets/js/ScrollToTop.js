 ...
 */
export function applyButtonStyles(button, config) {
 ...
 */
export function applySvgStyles(svg, config) {
 ...
 */
export function applyPathStyles(path, config) {
 ...
 */
export function shouldShowScrollButton(scrollThreshold = 20) {
 ...
 */
export function createButton(config, pageSimulator = null) {
 ...
 */
export function initScrollToTop(config = DEFAULT_SCROLL_CONFIG) {
